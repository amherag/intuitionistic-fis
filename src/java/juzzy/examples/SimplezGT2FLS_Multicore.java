 ...
 */
public class SimplezGT2FLS_Multicore 
{
    ...
    public SimplezGT2FLS_Multicore()
    {
        //Define the inputs
        ...
        System.out.println("Processing (& plotting) was completed in "+time/1000.0+" seconds.");
