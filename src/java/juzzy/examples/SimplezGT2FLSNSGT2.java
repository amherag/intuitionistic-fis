 ...
 */
public class SimplezGT2FLSNSGT2
{
    ...
    public SimplezGT2FLSNSGT2()
    {
        //Define the inputs
    	T1MF_Gaussian inputumf = new T1MF_Gaussian("inputumf",7,3);
    	T1MF_Gaussian inputlmf = new T1MF_Gaussian("inputlmf",7,2);
    	IntervalT2MF_Gaussian inputMfprimer = new IntervalT2MF_Gaussian("inputmfprimer",inputumf,inputlmf);
    	GenT2zMF_Gaussian inputMf = new GenT2zMF_Gaussian("inputmf",inputMfprimer,numberOfzLevels);
    ...
    private void getTip(double foodQuality, double serviceLevel)
    {
        ...
        System.out.println("The food was: "+food.getInput()+" (gaussian GT2 with a spread of : "+((GenT2zMF_Gaussian) food.getInputMF()).getZSlice(0).getUMF().getSpread()+" for UMF and " + ((GenT2zMF_Gaussian) food.getInputMF()).getZSlice(0).getLMF().getSpread()+" for LMF of the primer)");
